...
def main():
    ...
    for path in args.files:
        remove_output_file(
            ...
            remove_pycharm_metadata=args.remove_pycharm_metadata, preview=args.dry_run
        )
...
def remove_output_file(path, patterns, remove_kernel_metadata, remove_pycharm_metadata, preview):
...
def remove_output_object(data, patterns, remove_kernel_metadata, remove_pycharm_metadata):
